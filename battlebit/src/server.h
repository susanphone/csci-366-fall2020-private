...
typedef  struct game_server {           // Update values with threads and sockets as players come in
    ...
    int player_sockets[2]; // the client sockets that are inputting and outputting from the network
} game_server;
